...
<h4 class="" style="float:left; font-size: 35px; margin-left: 0.9%;">
    <?php
...
<div class="slider">
    <ul>
        <li><img src="img/211g.jpg" class="img-fluid" style="width:1290px; height:630px;"></li>
        <li><img src="img/23g.jpg" class="img-fluid" style="width:1290px; height:630px;"></li>
        <li><img src="img/26g.jpg" class="img-fluid" style="width:1290px; height:630px;"></li>
        <li><img src="img/28g.jpg" class="img-fluid" style="width:1290px; height:630px;"></li>
                ...
                <div class="jumbotron">
                    ...
                    <div class="con-cajas" align="center">
                        ...
                        <div class="cajas" align="center" style="width:250px; height:380px; display: inline-block;">
                            ...
                            <p style="font-size: 25px;">Zapatillas Runfalcon 2.0 Performance</p>
                            <p><b>S/.149.00</b></p>
                            <br>
                        </div>
                    </div>

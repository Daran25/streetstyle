...
<h4 class="" style="font-size: 35px; margin-left: 0.9%;">
    ...
    ?>
        ...
        <h2 class="text-center" style="font-size: 55px"><font color="Teal"><b>SECCIÓN HOMBRE</b></font></h2>
        <br>

<div class="slider">
    <ul>
        <li><img src="img/5g.jpg" class="img-fluid" style="width:1290px; height:630px;"></li>
        <li><img src="img/6g.jpg" class="img-fluid" style="width:1290px; height:630px;"></li>
        <li><img src="img/7g.jpg" class="img-fluid" style="width:1290px; height:630px;"></li>
        <li><img src="img/8g.jpg" class="img-fluid" style="width:1290px; height:630px;"></li>
    </ul>
</div>
<br>
<section>
